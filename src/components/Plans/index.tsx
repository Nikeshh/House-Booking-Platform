import { HomeOutline, Star } from "react-ionicons";
import house1 from "../../assets/images/plan1.jpg";
import house2 from "../../assets/images/plan2.jpg";
import house3 from "../../assets/images/plan3.jpg";

const Plans = () => {
	const plansList = [
		{ title: "Luxury Villa", image: house1, code: "Villa A101", price: "500" },
		{ title: "Cozy Cottage", image: house2, code: "Cottage B202", price: "300" },
		{ title: "Modern Apartment", image: house3, code: "Apartment C303", price: "400" },
	];
	return (
		<div className="flex w-full pt-5 pb-20 md:px-[200px] px-8 flex-col gap-16 justify-center items-center">
			<div className="flex flex-col w-full items-center">
				...
				<span className="font-semibold text-slate-700 text-3xl mt-1">Homes For Everyone</span>
				<p className="max-w-[400px] text-center mt-4">
					Discover our curated selection of luxurious homes designed to provide you with the ultimate comfort and pleasure.
				</p>
			</div>
					...
					return (
						...
						>
							...
							<div className="px-4 pt-4 leading-7 text-slate-700 max-w-[400px]">
								Enjoy the ultimate experience in our {plan.title}. Perfectly located and beautifully designed to meet all your needs.
							</div>
